            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Update Senate Detail</h4>
                    </div>
                    <div class="card-body">
                        <div class="form-validation">
                            <form class="" id="senate-detail-form">
                                <div class="row">
                                    <input type="hidden" name="id" value="{{ $senate->id}}">
                                    <div class="col-xl-12">
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-username">Title :
                                            </label>
                                            <div class="col-lg-8">
                                                <input type="text" class="form-control" id="val-username" value="{{ $senate->title}}" name="title" placeholder="Enter a Title..">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-8">
                                                ...
                                                <br>
                                                <img id="imagePreview" src="{{asset($senate->image) }}" style="width: 100px; height: 100px; {{ $senate->image == null ? 'display:none;' : '' }}" alt="Image Preview">
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-8">
                                                <textarea class="form-control" name="additional_information" rows="5">{{$senate->additional_information}}</textarea>
                                            </div>
                                        </div>
                                        <div class="form-group row">
    ...
    $(document).on("click", ".btn-submit", function(e) {
        ...
        swalWithBootstrapButtons.fire({
            ...
            if (result.isConfirmed) {
                ...
                var form = document.querySelector('#senate-detail-form');
                var data = new FormData(form);

                $.ajax({
                    url: "{{ url('admin/update-senate-detail')}}",
                    type: 'POST',
                    headers: {
