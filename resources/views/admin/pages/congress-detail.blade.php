            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Update Congress Detail</h4>
                    </div>
                    <div class="card-body">
                        <div class="form-validation">
                            <form class="" id="congress-detail-form">
                                <div class="row">
                                    ...
                                    <div class="col-xl-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-8">
                                                <input type="text" class="form-control" id="val-username" value="{{ $congress->title}}" name="title" placeholder="Enter a Title..">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-8">
                                                <textarea class="form-control" name="personal_detail" rows="5">{{$congress->personal_detail}}</textarea>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-8">
                                                <textarea class="form-control" name="additional_information" rows="5">{{$congress->additional_information}}</textarea>
                                            </div>
                                        </div>
                                        <div class="form-group row">
    ...
    $(document).on("click", ".btn-submit", function(e) {
        ...
        swalWithBootstrapButtons.fire({
            ...
            if (result.isConfirmed) {
                ...
                var form = document.querySelector('#congress-detail-form');
                var data = new FormData(form);

                $.ajax({
                    url: "{{ url('admin/update-congress-detail')}}",
                    type: 'POST',
                    headers: {
