        ...
        <div class="row page-titles mx-0">
            <div class="col-sm-6 p-md-0">
                <div class="welcome-text">
                    <h4>Fetch Congress Member</h4>
                </div>
            </div>
            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ url('admin/dashboard') }}">Home</a></li>
                    <li class="breadcrumb-item active"><a href="javascript:void(0);">Fetch Congress Member</a></li>
                </ol>
            </div>
        </div>
            ...
            <div class="col-xl-12 col-xxl-12 col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title">Fetch Congress Member Info</h5>
                    </div>
                    <div class="card-body">
                        <form id="member-form">
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="dropdown bootstrap-select form-control">
                                            <select class="form-control" tabindex="-98" name="congress">
                                                ...
                                                <option value="{{ $congress->name }}">{{ $congress->name}}</option>
                                                @endforeach
                                                @endif
                                            </select>
                                        </div>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <button type="button" id="btn-add-member" class="btn btn-primary">Submit</button>
                            </div>
                        </form>
                    </div>
                </div>
    ...
    $(document).on("click", "#btn-add-member", function(e) {
        ...
        swalWithBootstrapButtons.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    url: "{{ url('admin/fetch/congress/member')}}",
                    type: 'POST',
                    headers: {
