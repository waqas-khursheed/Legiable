        ...
        <div class="row page-titles mx-0">
            ...
            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="javascript:void(0);">Create Notification</a></li>
                </ol>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        <form id="notification-form">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <button type="button" id="btn-add-notification" class="btn btn-primary">Submit</button>
                            </div>
                        </form>
                    </div>
                </div>
...
*/
    ...
    // Add Quote 
    $(document).on("click", "#btn-add-notification", function(e) {
        e.preventDefault();
        ...
        swalWithBootstrapButtons.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    url: "{{ url('admin/notification/send')}}",
                    type: 'POST',
                    headers: {
